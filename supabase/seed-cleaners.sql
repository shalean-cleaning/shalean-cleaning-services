-- Seed data for cleaners in Shalean booking system
-- This script adds sample cleaner profiles and their availability

-- First, we need to create profiles for cleaners
-- Note: In a real application, these would be created through Supabase Auth signup
...
-- Insert cleaner availability schedules
